...
<div class="col-md-6 col-lg-3">
  <div class="card pizza-card h-100" onclick="location.href='<?= e(route('product', ['slug' => $product['slug']])) ?>'">
    <div class="position-relative">
      <img src="<?= e(asset($product['image_path'] ?: 'images/logo.png')) ?>" class="card-img-top pizza-img" alt="<?= e($product['name']) ?>" />
      <?php if ($primaryTag): ?>
    ...
    <div class="card-body d-flex flex-column">
      ...
      <div class="d-flex justify-content-between align-items-center mt-auto">
        <span class="h5 text-dark mb-0">от <?= e(format_price($product['min_price'])) ?></span>
